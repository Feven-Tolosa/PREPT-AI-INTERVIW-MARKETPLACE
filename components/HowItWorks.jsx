  ...
  return (
    <section className="relative z-10 py-28 max-w-5xl mx-auto px-6">
      <div className="text-center mb-20">
        ...
        <SectionHeading
          gray="From sign-up to"
          gold="interview-ready"
        />
      </div>

      <div className="relative">
        {/* Connecting line */}
        <div className="hidden md:block absolute top-12 left-[calc(12.5%+22px)] right-[calc(12.5%+22px)] h-px bg-gradient-to-r from-amber-400/0 via-amber-400/30 to-amber-400/0" />
