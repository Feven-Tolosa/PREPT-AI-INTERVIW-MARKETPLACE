...
function AIFeedbackView({ active }) {
  ...
  const SCORES = [
    { label: "Technical Depth", score: 85, color: "from-amber-400 to-amber-500" },
    { label: "Communication", score: 92, color: "from-emerald-400 to-emerald-500" },
    { label: "Problem Solving", score: 78, color: "from-blue-400 to-blue-500" },
    { label: "Code Quality", score: 88, color: "from-violet-400 to-violet-500" },
  ];

  const HIGHLIGHTS = [
    { type: "good", text: "Strong understanding of React fundamentals" },
    { type: "good", text: "Clear, structured communication style" },
    { type: "improve", text: "Consider mentioning trade-offs in reconciliation" },
