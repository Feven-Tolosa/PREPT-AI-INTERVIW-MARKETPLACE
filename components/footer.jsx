        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-16 border-b border-border">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2.5 text-xs text-muted-foreground">
              ...
              <li>
                <Link href="/appointments" className="hover:text-amber-300 transition-colors">
                  My Appointments
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2.5 text-xs text-muted-foreground">
              ...
              <li>
                <Link href="/explore?category=BACKEND" className="hover:text-amber-300 transition-colors">
                  Backend Systems
                </Link>
              </li>
              <li>
                <Link href="/explore?category=FULLSTACK" className="hover:text-amber-300 transition-colors">
                  Fullstack Architecture
                </Link>
              </li>
              <li>
                <Link href="/explore?category=SYSTEM_DESIGN" className="hover:text-amber-300 transition-colors">
                  System Design
                </Link>
              </li>
              <li>
                <Link href="/explore?category=BEHAVIORAL" className="hover:text-amber-300 transition-colors">
