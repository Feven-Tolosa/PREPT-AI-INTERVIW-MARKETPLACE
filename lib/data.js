...
export const TESTIMONIALS = [
  {
    ...
    initials: "PS",
    text: "Prept completely changed how I approached system design interviews. The AI feedback pointed out patterns I never noticed — like over-engineering early instead of starting with the simplest solution. After 3 sessions, I cleared my L5 loop.",
    rating: 5,
    color: "amber",
  },
  {
    ...
    initials: "MJ",
    text: "I've interviewed on the other side for years, but Prept helped me stay sharp as a candidate too. The AI co-pilot generating questions in real-time is insane — it felt exactly like my actual Amazon loop.",
    rating: 5,
    color: "emerald",
  },
  {
  ...
  },
  {
    ...
    initials: "JO",
    text: "As an interviewer on Prept, I love the AI question generator. It tailors questions to each candidate's level so I can focus on evaluating their responses rather than thinking of what to ask next.",
    rating: 5,
    color: "emerald",
  },
];
...
export const FAQ_ITEMS = [
  {
    question: "How do mock interviews on Prept work?",
    answer:
  ...
  {
    question: "Can I become an interviewer on Prept?",
    answer:
