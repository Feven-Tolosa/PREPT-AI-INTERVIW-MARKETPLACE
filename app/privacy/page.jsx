import { ShieldCheck, Lock, Eye, Server, Users, Mail, Clock, FileCheck, Cookie } from "lucide-react";

export const metadata = {
  title: "Privacy Policy | PREPT",
  description: "Learn how PREPT collects, uses, protects, and retains your personal information when using our AI-powered mock interview platform.",
};
        ...
        <div className="space-y-12 text-sm leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-none space-y-3 pl-4">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Create, authenticate, and maintain candidate and interviewer user accounts.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Schedule, match, and facilitate live 1:1 video mock interviews between candidates and expert interviewers.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Process session transcripts using Google Gemini to generate tailored interview questions and evaluation reports.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Manage candidate credit balances, process interview payments, and handle interviewer payout requests.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Send transactional emails, appointment confirmations, and payout status updates via Resend.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span>Protect the platform against spam, bot traffic, automated abuse, and rate limits via Arcjet.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
              {[
                { name: "Clerk", purpose: "User authentication, identity & session management" },
                { name: "Stream", purpose: "Live video calling, audio streaming & real-time chat" },
                { name: "Google Gemini", purpose: "AI interview question generation & automated transcript feedback" },
                { name: "Resend", purpose: "Transactional emails & appointment notification delivery" },
          ...
          <section className="space-y-4">
            ...
            <ul className="list-none space-y-3 pl-4">
              <li className="flex items-start gap-3">
                ...
                <span>All data transmitted between your browser and our servers is encrypted using standard TLS/SSL protocols.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-2 shrink-0" />
                <span>Database records are encrypted at rest via Supabase / PostgreSQL cloud infrastructure.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-2 shrink-0" />
                <span>Authentication credentials are managed securely by Clerk with multi-factor authentication support.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-2 shrink-0" />
