        ...
        <div className="space-y-12 text-sm leading-relaxed">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">2. Eligibility</h2>
            </div>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">3. User Accounts &amp; Roles</h2>
            </div>
            <p className="text-muted-foreground">Users may register on PREPT as either Candidates or Interviewers:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
              <div className="rounded-lg bg-muted/30 border border-border px-5 py-4">
                <p className="text-foreground font-semibold text-sm mb-1">👤 Candidate</p>
                <p className="text-muted-foreground text-xs">Browse interviewers, purchase credits, book mock interview sessions, receive AI evaluations, and manage appointments.</p>
              </div>
              <div className="rounded-lg bg-muted/30 border border-border px-5 py-4">
                <p className="text-foreground font-semibold text-sm mb-1">🎯 Interviewer</p>
                <p className="text-muted-foreground text-xs">Publish availability timeslots, conduct mock interviews, set rates, receive payouts, and build a public profile.</p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">4. Platform Use &amp; Prohibited Conduct</h2>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">5. Interview Bookings</h2>
            </div>
            <ul className="list-none space-y-3 pl-4">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Booking Mechanism:</strong> Candidates select available timeslots published by interviewers and confirm booking using platform credits.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Attendance:</strong> Both candidates and interviewers are expected to join the video session on time.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Cancellations &amp; Rescheduling:</strong> Cancellations or rescheduling requests must comply with platform appointment guidelines prior to session start.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">6. Payments, Credits &amp; Payouts</h2>
            </div>
            <ul className="list-none space-y-3 pl-4">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Credit Purchases:</strong> Candidates purchase credits to book mock interviews. Credit balances and rates are displayed on the platform.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Credit Deductions:</strong> Credits are deducted from candidate balances upon appointment confirmation.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Interviewer Payouts:</strong> Interviewers accumulate credit earnings for completed sessions. Payout requests are subject to administrative review.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0" />
                <span><strong className="text-foreground">Refund Policy:</strong> Refunds for unfulfilled sessions or technical failures are reviewed on a case-by-case basis.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">7. AI Features Disclaimer</h2>
            </div>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">9. Limitation of Liability</h2>
            </div>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">10. Account Suspension &amp; Termination</h2>
            </div>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">11. Changes to Terms</h2>
            </div>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-serif text-xl text-foreground">12. Contact &amp; Legal Support</h2>
            </div>
            <p className="text-muted-foreground">
